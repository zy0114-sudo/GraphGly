...
#train
file='/data5_large/home/yanzh/deeplearn/graph_residue/my_data/protein_new_3222/dataset_shuanglian_buchong/a_picture5/train/npz'
...
dataset_train=MyOwnDataset('/data5_large/home/yanzh/deeplearn/graph_residue/my_data/protein_new_3222/dataset_shuanglian_buchong/a_picture5/train/pt')



#test
file1='/data5_large/home/yanzh/deeplearn/graph_residue/my_data/protein_new_3222/dataset_shuanglian_buchong/a_picture5/test/npz'
...
dataset_test=MyOwnDataset2('/data5_large/home/yanzh/deeplearn/graph_residue/my_data/protein_new_3222/dataset_shuanglian_buchong/a_picture5/test/pt')
...
for epoch in range(config_runtime['num_epochs']):
   ...
   # train_recall = a3[1]
    ...
    '''
    output_path='/data5_large/home/yanzh/deeplearn/graph_residue/my_data/protein_new_3222/dataset_shuanglian_buchong/a_picture5/model/model1'
    #if test_acc >= 0.7:
    #    print('测试集的准确率为%s，在第%d中'%(t_acc,epoch))
    torch.save(model.state_dict(), "/data5_large/home/yanzh/deeplearn/graph_residue/my_data/protein_new_3222/dataset_shuanglian_buchong/a_picture5/model/model1/%d_model.pt"%epoch)
